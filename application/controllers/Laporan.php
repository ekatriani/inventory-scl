...
class Laporan extends CI_Controller
{
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $pdf->Image('./assets/img/LOGOSCL.jpg',10,8,17,15);
        $pdf->Image('./assets/img/LOGOSCL.jpg',255,8,15,14);
        ...
        if ($table_ == 'barang_masuk') :
            ...
            $pdf->Ln(60);
                $pdf->Cell(75);
                $pdf->Cell(270,7,'Tegal, '.date('d-m-y'),0,1,'C');
                $pdf->Cell(75);
                $pdf->Cell(270,7,'PPIC,',0,1,'C');    
                $pdf->Ln(20);
                $pdf->Cell(75);
                $pdf->SetFont('Times','B',15);
                $pdf->Cell(270,7,'Ahmad Alfian',0,1,'C');
