        ...
        <div class="card border-left-primary h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="barang" style="text-decoration:none;color:#2A6AFF" >Total Data PART</a></div>
      ...
      <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="barangmasuk" style="text-decoration:none; color:#FFA600  " >FG STORE</a></div>
     ...
     <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-danger h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="barangkeluar" style="text-decoration:none; color:#FF0000 " >Part Keluar</a></div>
      ...
      <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-primary h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                         <a href="https://time.is/Tegal" id="time_is_link" rel="nofollow" style="font-size:15px">Tegal,</a>
                         <span id="Bandung_z41c" style="font-size:15px"></span>
                         <script src="//widget.time.is/t.js"></script>
                         <script>time_is_widget.init({Tegal_z41c:{}});</script>
                    </div>
                </div>
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
