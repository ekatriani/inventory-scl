        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('barangpo') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_po_masuk' => $id_po_masuk, 'user_id' => $this->session->userdata('login_session')['user']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_po_masuk">ID Transaksi Barang Masuk</label>
                    <div class="col-md-4">
                        <input value="<?= $id_po_masuk; ?>" type="text" readonly="readonly" class="form-control">
                        <?= form_error('id_po_masuk', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="supplier_id">Customer</label>
                    <div class="col-md-5">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jumlah_po">Jumlah Permintaan</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_po'); ?>" name="jumlah_po" id="jumlah_po" type="number" class="form-control" placeholder="Jumlah ...">
                            <div class="input-group-append">
                                <span class="input-group-text" id="satuan">Satuan</span>
                            </div>
                        </div>
                        <?= form_error('jumlah_po', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
